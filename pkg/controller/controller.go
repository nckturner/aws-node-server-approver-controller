...
func NewController(cfg *config.AWSNodeServerApproverConfig) (*Controller, error) {
	// creates the connection
	config, err := clientcmd.BuildConfigFromFlags(cfg.Options.Master, cfg.Options.Kubeconfig)
	if err != nil {
		glog.Fatal(err)
	}
